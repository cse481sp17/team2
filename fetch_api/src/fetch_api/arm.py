...
class Arm(object):
	...
	self.client.wait_for_server()
        ...
        self.moveGroupAction = actionlib.SimpleActionClient(MOVE_GROUP_ACTION, MoveGroupAction)
        self.moveGroupAction.wait_for_server()
    ...
    def cancel_all_goals(self):
        ...
        self.moveGroupAction.cancel_all_goals()
